...
public class bookSelectScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawStringWithShadow(matrices, this.textRenderer, Text.translatable("category.notebook.presets").getString(), (int) (this.width / 2 - (Text.translatable("category.notebook.presets").getString().length()/2 * 5))-5, 12, 16777215);
