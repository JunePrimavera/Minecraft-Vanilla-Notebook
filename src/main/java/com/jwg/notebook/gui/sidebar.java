...
public class sidebar {
    public static TexturedButtonWidget addSidebarButton(int pos, Identifier BUTTON_TEXTURE, Screen BOOK_MENU, String buttonID) {
        return new TexturedButtonWidget(BOOK_MENU.width/2 +90, 18+(12*pos), 8, 8, 0, 0, 8, BUTTON_TEXTURE, 8, 16, button -> buttonAction(buttonID), Text.translatable("jwg.button."+buttonID));
    }
